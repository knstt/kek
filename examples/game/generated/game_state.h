...
typedef struct Game_stateStateSlots {
    KekStateHandle frame;
    KekStateHandle session;
    KekStateHandle input;
    KekStateHandle player;
    KekStateHandle wave;
    KekStateHandle camera;
    KekStateHandle grunt_enemy;
    KekStateHandle runner_enemy;
    KekStateHandle tank_enemy;
    KekStateHandle boss_enemy;
